...
#
# NOTE: the language metrics (copy/CHAIR/BLEU/METEOR/CIDEr) require the SYNTHETIC data + narrator; real
# datasets are vision-only. run_eval reads DATASET/READER/CKPT/SCENES/REAL_TRANSFER from the env (pass-through).
