...
# no retraining. Drops BLEU/METEOR/CIDEr (not faithfulness); CHAIR backs the FULL marker set.
#
...
#   DATASET=smeaheia READER=hybrid/checkpoints/ab_experiment/B_joint.pt scripts/eval_language.sh
#
