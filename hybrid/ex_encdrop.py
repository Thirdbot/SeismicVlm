...
from model.reader import RegionReader
from stages.stage2_reader import _build_encoder
from eval.benchmark import bench                       # EXISTING benchmark fn — no new metric code
...
if ENC == "ncs":
    from model.encoder import NcsEncoder
